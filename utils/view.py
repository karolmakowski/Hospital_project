...
przychodnie = [
    Przychodnia("Medica Kobyłka", "doktorzy: dr. Andrzej Rafał, dr. Rafał Andrzej",
                "pacjenci: Maciej Marek, Marek Maciej, Miłosz Wojciech, Wojciech Miłosz", "Kobyłka"),
    Przychodnia("Care Ząbki", "doktorzy: dr. Michał Artur, dr. Artur Michał",
                "pacjenci: Anna Maria, Maria Anna, Aleksandra Leokadia, Leokadia Aleksandra", "Ząbki"),
    Przychodnia("Lux Słupno", "doktorzy: dr. Karol Marcin, dr. Marcin Karol",
                "pacjenci: Agnieszka Elżbieta, Elżbieta Agnieszka, Paweł Gaweł, Gaweł Paweł", "Słupno_(gmina)"),
    Przychodnia("Marvit Wyszków", "doktorzy: dr. Joanna Magda, dr. Magda Joanna",
                "pacjenci: Andrzej Kacper, Kacper Andrzej, Adrianna Urszula, Urszula Adrianna", "Wyszków"),
    Przychodnia("Prima Tłuszcz", "doktorzy: dr. Oliwia Paulina, dr. Paulina Oliwia",
                "pacjenci: Jakub Piotr, Piotr Jakub, Janina Weronika, Weronika Janina", "Tłuszcz_(miasto)")
]
...
def aktualizuj_przychodnie(i, entry_nazwa, entry_doktorzy, entry_pacjenci, entry_lokalizacja,
                           button_dodaj_przychodnie, listbox_lista_przychodni, map_widget):
    przychodnia = przychodnie[i]
...
def okno_przychodnie(root):
    ...
    przychodnie_root.geometry("1200x900")
    ...
    listbox_lista_przychodni = Listbox(ramka_lista_przychodni, width=150)
...
lekarze = [
    Lekarz("Andrzej", "nazwisko: Rafał", "placówka: Medica Kobyłka", "pacjenci: Maciej Marek, Miłosz Wojciech",
           "Kobyłka"),
    Lekarz("Rafał", "nazwisko: Andrzej", "placówka: Medica Kobyłka", "pacjenci: Marek Maciej, Wojciech Miłosz",
           "Wołomin"),
    Lekarz("Michał", "nazwisko: Artur", "placówka: Care Ząbki", "pacjenci: Anna Maria, Aleksandra Leokadia",
           "Wałbrzych"),
    Lekarz("Artur", "nazwisko: Michał", "placówka: Care Ząbki", "pacjenci: Maria Anna, Leokadia Aleksandra", "Lublin"),
    Lekarz("Karol", "nazwisko: Marcin", "placówka: Lux Słupno", "pacjenci: Agnieszka Elżbieta, Paweł Gaweł",
           "Warszawa"),
    Lekarz("Marcin", "nazwisko: Karol", "placówka: Lux Słupno", "pacjenci: Elżbieta Agnieszka, Gaweł Paweł", "Łódź"),
    Lekarz("Joanna", "nazwisko: Magda", "placówka: Marvit Wyszków", "pacjenci: Andrzej Kacper, Adrianna Urszula",
           "Wyszków"),
    Lekarz("Magda", "nazwisko: Joanna", "placówka: Marvit Wyszków", "pacjenci: Kacper Andrzej, Urszula Adrianna",
           "Jadów"),
    Lekarz("Oliwia", "nazwisko: Paulina", "placówka: Prima Tłuszcz", "pacjenci: Jakub Piotr, Janina Weronika",
           "Kołobrzeg"),
    Lekarz("Paulina", "nazwisko: Oliwia", "placówka: Prima Tłuszcz", "pacjenci: Piotr Jakub, Weronika Janina",
           "Międzyzdroje")
...
def okno_lekarze(root):
    ...
    lekarze_root.geometry("1200x900")
    ...
    listbox_lista_lekarzy = Listbox(ramka_lista_lekarzy, width=100)
...
pacjenci = [
    Pacjent("Maciej", "nazwisko: Marek", "przychodnia: Medica Kobyłka", "Kobyłka"),
    Pacjent("Marek", "nazwisko: Maciej", "przychodnia: Medica Kobyłka", "Wołomin"),
    Pacjent("Miłosz", "nazwisko: Wojciech", "przychodnia: Medica Kobyłka", "Zielonka_(miasto)"),
    Pacjent("Wojciech", "nazwisko: Miłosz", "przychodnia: Medica Kobyłka", "Nadma"),
    Pacjent("Anna", "nazwisko: Maria", "przychodnia: Care Ząbki", "Ząbki"),
    Pacjent("Maria", "nazwisko: Anna", "przychodnia: Care Ząbki", "Warszawa"),
    Pacjent("Aleksandra", "nazwisko: Leokadia", "przychodnia: Care Ząbki", "Radzymin"),
    Pacjent("Leokadia", "nazwisko: Aleksandra", "przychodnia: Care Ząbki", "Marki"),
    Pacjent("Agnieszka", "nazwisko: Elżbieta", "przychodnia: Lux Słupno", "Słupno_(gmina)"),
    Pacjent("Elżbieta", "nazwisko: Agnieszka", "przychodnia: Lux Słupno", "Cegielnia_(powiat_wołomiński)"),
    Pacjent("Paweł", "nazwisko: Gaweł", "przychodnia: Lux Słupno", "Stary_Dybów"),
    Pacjent("Gaweł", "nazwisko: Paweł", "przychodnia: Lux Słupno", "Stary_Kraszew"),
    Pacjent("Andrzej", "nazwisko: Kacper", "przychodnia: Marvit Wyszków", "Wyszków"),
    Pacjent("Kacper", "nazwisko: Andrzej", "przychodnia: Marvit Wyszków", "Niegów"),
    Pacjent("Adrianna", "nazwisko: Urszula", "przychodnia: Marvit Wyszków", "Natalin_(powiat_wyszkowski)"),
    Pacjent("Urszula", "nazwisko: Adrianna", "przychodnia: Marvit Wyszków", "Trzcianka_(powiat_wyszkowski)"),
    Pacjent("Jakub", "nazwisko: Piotr", "przychodnia: " "Prima Tłuszcz", "Tłuszcz_(miasto)"),
    Pacjent("Piotr", "nazwisko: Jakub", "przychodnia: Prima Tłuszcz", "Jadów"),
    Pacjent("Janina", "nazwisko: Weronika", "przychodnia: Prima Tłuszcz", "Klembów"),
    Pacjent("Weronika", "nazwisko: Janina", "przychodnia: Prima Tłuszcz", "Wójty")
]
...
def okno_pacjenci(root):
    ...
    pacjenci_root.geometry("1200x900")
    ...
    listbox_lista_pacjentow = Listbox(ramka_lista_pacjentow, width=100)
...
def main_window():
    ...
    label = Label(frame, text="Wybierz opcję:")
    label.pack(pady=10)

    button1 = Button(frame, text="Lista przychodni", width=15, command=lambda: okno_przychodnie(root))
    button1.pack(pady=10)

    button2 = Button(frame, text="Lista lekarzy", width=15, command=lambda: okno_lekarze(root))
    button2.pack(pady=10)

    button3 = Button(frame, text="Lista pacjentów", width=15, command=lambda: okno_pacjenci(root))
